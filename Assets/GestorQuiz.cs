...
public class GestorQuiz : MonoBehaviour
{
    ...
    public TextMeshProUGUI Pontos;   // Caixa de texto onde aparece a pergunta
    ...
    {
        CarregarJSON();
        AtualizarPontos();         // 1. Ler ficheiro JSON
        MostrarPergunta();       // 2. Mostrar a primeira pergunta
    }
    ...
    void CarregarJSON()
    {
        ...
        ListaQuestao lista = JsonUtility.FromJson<ListaQuestao>(ficheiro.text);
